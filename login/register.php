...
<body>
    <div class="black-bg" style=" justify-content: center; align-items: center; height: 100vh;" id="modal">
        <div class="white-bg" style="text-align: center;">
            <h4><strong id="modal-content" ></strong></h4>
            <div class="pro-box">
        ...
        <div class="regcontainer">
            ...
            <div class="card-body">
                <form class="form-signin" action="./regAction.php" method="POST" ><br>
                    <input type="text" id="uid" class="form-control" placeholder="👤 아이디" required autofocus name="uid" autocomplete="off" autofocus >
                    <input type="password" id="upw" class="form-control" placeholder="🔒 비밀번호" required autofocus name="upw" autocomplete="off" >
                    <input type="password" id="upw2" class="form-control" placeholder="🔒 비밀번호 확인" required autofocus name="upw2" autocomplete="off" >
                    <input type="text" id="email" class="form-control" placeholder="🗓️ [선택] 이메일주소(본인 확인용)" autofocus name="email" autocomplete="off" autofocus style="margin-bottom:15px;">
                    <input type="text" id="name" class="form-control" placeholder="👤 이름" required autofocus name="name" autocomplete="off" autofocus>
                    <input type="text" id="ssn" class="form-control" placeholder="🗓️ 생년월일 8자리" required autofocus name="ssn" autocomplete="off" autofocus>
                    <input type="text" id="phone" class="form-control" placeholder="📱 휴대전화번호" required autofocus name="phone" autocomplete="off" autofocus style="margin-bottom:15px;">
...
본 약관은 코드런(이하 "회사")이 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 회사의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.<br><br>
<strong>제2조(약관의 효력 및 변경)</strong><br>
① 회사은 귀하가 본 약관 내용에 동의하는 것을 조건으로 귀하에게 서비스를 제공할 것이며, 귀하가 본 약관의 내용에 동의
    하는 경우, 회사의 서비스 제공 행위 및 귀하의 서비스 사용 행위에는 본 약관이 우선적으로 적용될 것입니다.<br>

② 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 회사의 초기화면에 그 적용일자 7일 이전부터
    적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을
    두고 공지합니다. 이 경우 회사은 개정 전 내용과 개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.
    이용자가 변경된 약관에 동의하지 않는 경우, 이용자는 본인의 회원등록을 취소(회원탈퇴)할 수 있으며 계속 사용의 경우는 약관
    변경에 대한 동의로 간주됩니다.<br><br>

<strong>제3조(약관 외 준칙)</strong><br>
① 본 약관은 회사이 제공하는 서비스에 관한 이용규정 및 별도 약관과 함께 적용됩니다.<br>
...
① 이용자 : 본 약관에 따라 회사이 제공하는 서비스를 받는 자<br>
② 가입 : 회사이 제공하는 회원가입 양식에 해당 정보를 기입하고, 본 약관에 동의하여 서비스 이용 계약을 완료시키는 행위<br>
③ 회원 : 회사에 개인 정보를 제공하여 회원 등록을 한 자로서, 회사의 정보를 제공받으며, 회사이 제공하
...
① 이용계약은 신청자가 온라인으로 회사에서 제공하는 소정의 회원가입 신청양식에서 요구하는 사항을 기록하여 가입을 완
    료하는 것으로 성립됩니다.<br>
② 회사은 다음 각 호에 해당하는 이용계약에 대하여는 가입을 취소할 수 있습니다.<br>
- 다른 사람의 명의를 사용하여 신청하였을 때<br>
- 이용 계약 신청서의 내용을 허위로 기재하였거나 신청하였을 때<br>
- 사회의 안녕 질서 혹은 미풍양속을 저해할 목적으로 신청하였을 때<br>
- 다른 사람의 회사 서비스 이용을 방해하거나 그 정보를 도용하는 등의 행위를 하였을 때<br>
- 회사을 이용하여 법령과 본 약관이 금지하는 행위를 하는 경우<br>
- 기타 회사이 정한 이용신청요건이 미비 되었을 때<br>
③ 회사은 다음 각 항에 해당하는 경우 그 사유가 해소될 때까지 이용계약 성립을 유보할 수 있습니다.<br>
- 서비스 관련 제반 용량이 부족한 경우<br>
- 기술상 장애 사유가 있는 경우<br>
④ 회사이 제공하는 서비스는 아래와 같으며, 그 변경될 서비스의 내용을 이용자에게 공지하고 아래에서 정한 서비스를 변경
    하여 제공할 수 있습니다.<br>
- E-mail을 통한 대·중소기업·농어업협력재단의 각종 정보 제공<br>
- 회사이 자체 개발하거나 다른 기관과의 협의 등을 통해 제공하는 일체의 서비스<br><br>
<strong>제6조(회원정보사용에대한동의)</strong><br>
① 회원의 개인정보에 대해서는 회사의 개인정보 보호정책이 적용됩니다.<br>
② 회사의 회원 정보는 다음과 같이 수집, 사용, 관리, 보호됩니다.<br>
- 개인정보의 수집 : 회사은 귀하의 회사 서비스 가입시 귀하가 제공하는 정보를 통하여 귀하에 관한 정보를 수
   집하며 탈퇴시 수집된 모든 개인정보는 삭제됩니다. 다만, 회사(이전 시스템 포함)을 통해 정부지원사업을 참여한
   이력이 있는 경우 각 지원사업의 관련법령이 정하는 바에 따라 일부 정보는 과제정보로서 보관되어 질 수 있습니다.<br>
- 개인정보의 사용 : 회사은 회사 서비스 제공과 관련해서 수집된 회원의 신상정보를 본인의 승낙 없이 제3자에
   ...
   귀하가 회사에 제공한 개인정보를 스스로 공개한 경우에는 그러하지 않습니다.<br>
...
③ 회원이 회사에 본 약관에 따라 이용신청을 하는 것은 이용신청이 적용되는 기간동안 회사이 본 약관에 따라 신청
    서에 기재된 회원정보를 수집, 이용하는 것에 동의하는 것으로 간주됩니다.<br><br>
<strong>제7조(정보보안)</strong><br>
① 가입 신청자가 회사 서비스 가입 절차를 완료하는 순간부터 귀하는 입력한 정보의 비밀을 유지할 책임이 있으며, 회원의
    ID와 비밀번호를 사용하여 발생하는 모든 결과에 대한 책임은 회원본인에게 있습니다.<br>
② ID와 비밀번호에 관한 모든 관리의 책임은 회원에게 있으며, 회원의 ID나 비밀번호가 부정하게 사용 되었다는 사실을 발견한 경우에
    는 즉시 회사에 신고하여야 합니다. 신고를 하지 않음으로 인한 모든 책임은 회원 본인에게 있습니다.<br>
③ 이용자는 회사 서비스의 사용 종료시 마다 정확히 접속을 종료하도록 해야 하며, 정확히 종료하지 아니함으로써 제3자가
    귀하에 관한 정보를 이용하게 되는 등의 결과로 인해 발생하는 손해 및 손실에 대하여 회사은 책임을 부담하지
    아니합니다.<br>
④ 관리시스템은 쿠키를 활용하여 개인정보를 수집하지 아니하며 인터넷 접속파일 등 개인정보를 자동으로 설치하는 장치를 거부하며
    관련된 장치를 운영하지 않습니다.<br>
⑤ 회사은 수집·활용 중인 개인정보가 누출되고 그 사실을 인지시 개인정보 항목 및 발생시점 경위를 사용자에게 통보한다.<br><br>
<strong>제8조(서비스이용시간)</strong><br>
① 서비스 이용시간은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간을 원칙으로 합니다.<br>
② 제1항의 이용시간은 정기점검 등의 필요로 인하여 회사이 정한 날 또는 시간은 예외로 합니다.<br><br>
<strong>제9조(서비스의중지및정보의저장과사용)</strong><br>
① 귀하는 회사 서비스에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 국가의 비상사태, 정전, 회사
    의 관리 범위 외의 서비스 설비 장애 및 기타 불가항력에 의하여 보관되지 못하였거나 삭제된 경우, 전송되지 못한 경우 및 기타
    통신 데이터의 손실이 있을 경우에 회사은 관련 책임을 지지 아니합니다.<br>
② 회사이 정상적인 서비스 제공의 어려움으로 인하여 일시적으로 서비스를 중지하여야 할 경우에는 서비스 중지 1주일 전의
    고지 후 서비스를 중지할 수 있으며, 이 기간 동안 귀하가 고지내용을 인지하지 못한 데 대하여 회사은 책임을 부담하지
    ...
    기타 통신 데이터의 손실이 있을 경우에 대하여도 회사은 책임을 부담하지 아니합니다.<br>
③ 회사의 사정으로 서비스를 영구적으로 중단하여야 할 경우 제 2 항에 의거합니다. 다만, 이 경우 사전 고지기간은 1개월로
    합니다.<br>
④ 회사은 사전 고지 후 서비스를 일시적으로 수정, 변경 및 중단할 수 있으며, 이에 대하여 귀하 또는 제3자에게 어떠한 책임
    도 부담하지 아니합니다.<br>
⑤ 회사은 이용자가 본 약관의 내용에 위배되는 행동을 한 경우, 임의로 서비스 사용을 제한 및 중지 할 수 있습니다. 이 경우
    회사은 위 이용자의 접속을 금지할 수 있습니다.<br><br>
<strong>제10조(서비스의변경및해지)</strong><br>
회사은 귀하가 서비스를 이용하여 기대하는 손익이나 서비스를 통하여 얻은 자료로 인한 손해에 관하여 책임을 지지 않으며, 회원이 본 서비스에 게재한 정보, 자료, 사실의 신뢰도, 정확성 등 내용에 관하여는 책임을 지지 않습니다.<br>`

        const text2 = `코드런(이하 “회사” 라 한다)은 「개인정보보호법」 제15조 제1항 제1호, 제17조 제1항 제1호, 제23조 제1호 따라 아래와 같이 개인정보의 수집. 이용에 관하여 귀하의 동의를 얻고자 합니다.<br><br>
